...
const dataSources = ref([
  ...
  { id: 3, name: '工作成果', icon: '📋', status: 'pending', statusText: '待处理', progress: 0 },
  { id: 4, name: '任务交付', icon: '✅', status: 'pending', statusText: '待处理', progress: 0 },
  { id: 5, name: '外部信号', icon: '🌐', status: 'pending', statusText: '待处理', progress: 0 }
])
